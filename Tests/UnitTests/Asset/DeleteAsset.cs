...
{
    [TestFixture()]
    public class NUnitDeleteAsset
    {
        [Test(Description = "Delete Asset")]
        public async void delete_asset()
        {
            ...
            var APIDeleteResponse = await FormitizeHelper.Asset.DeleteAsset(
                client,
                APIResponse.Payload.SchemaID,
                APIResponse.Payload.AssetID
            );
            Assert.IsInstanceOf(typeof(Response<DeleteAssetResponse>), APIDeleteResponse);
        }
    }
}
