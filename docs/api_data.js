define({ "api": [
  ...
  },
  {
        ...
        "Arguements": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Returns client, contact and location information.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "CURL Sample",
        "content": "curl -A YourCompany -u admin:password -X \"GET\" https://service.formitize.com/api/rest/v2/crm/client/55",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "group": "Job",
    "version": "1.0.0",
    "description": "<p>Get the specified job.</p>",
    "examples": [
      {
        "title": "CURL Sample",
        "content": "curl -A YourCompany -u admin:password https://service.formitize.com/api/rest/v2/job/5555",
        "type": "json"
      }
    ],
    "success": {
